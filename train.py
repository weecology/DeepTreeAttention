...
autoencoder_model = autoencoder.autoencoder(train_df=train.head(100), val_df=data_module.test, classes=data_module.num_classes, config=config, comet_logger=comet_logger)
trainer = Trainer(
