...
autoencoder_model = autoencoder.autoencoder(train_df=data_module.train, val_df=data_module.test, classes=data_module.num_classes, config=config, comet_logger=comet_logger)
trainer = Trainer(
