...
if __name__ == "__main__":
    ...
    #Plots
    visualize.plot_crown_position(model = model.ensemble_model, path = model.config["evaluation"]["ground_truth_path"], eval_dataset_with_index=model.val_split_with_ids)
