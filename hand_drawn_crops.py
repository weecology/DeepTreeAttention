...
crowns = crowns[crowns.individualID.isin(test.individualID)]
...
for index, row in test.iterrows():
    ...
    basename = row["individualID"]
    patches.crop(row["geometry"].bounds, sensor_path, savedir="/orange/idtrees-collab/DeepTreeAttention/hand_annotations/", basename=basename)
